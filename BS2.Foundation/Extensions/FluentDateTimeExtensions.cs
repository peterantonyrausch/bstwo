...
namespace BS2.Foundation.Extensions
{
    public static class FluentDateTimeExtensions
    {
        ...
        /// <summary>
        ///     Returns a new <see cref="DateTimeOffset" /> value for the specified <paramref name="date" /> and time with the
        ///     specified
        ///     <paramref name="hours" />, <paramref name="minutes" /> and optionally <paramref name="seconds" />.
        /// </summary>
        public static DateTimeOffset At(this DateTimeOffset date, int hours, int minutes, int seconds = 0,
            int milliseconds = 0, int microseconds = 0, int nanoseconds = 0)
        {
            ...
            var value = new DateTimeOffset(date.Year, date.Month, date.Day, hours, minutes, seconds, milliseconds,
                date.Offset);
